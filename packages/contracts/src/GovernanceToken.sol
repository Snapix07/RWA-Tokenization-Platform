...
/// @notice ERC-20 governance token with on-chain voting weight snapshots (ERC20Votes),
///         gasless approvals (ERC20Permit), and role-gated minting (AccessControl).
///
/// Design patterns: AccessControl.
contract GovernanceToken is ERC20, ERC20Permit, ERC20Votes, AccessControl {
        ...
        ERC20Permit("RWA Governance Token")
    {
        ...
        if (initialSupply > 0) _mint(initialAdmin, initialSupply);
    }
